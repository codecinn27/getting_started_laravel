...
<body>
    ...
    <nav class="bg-gray-800">
        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="ml-4 flex items-center md:ml-6">
                ...
                <div>
                    ...
                    <img class="h-8 w-8 rounded-full" src="https://media.istockphoto.com/id/1960517375/photo/unrecognized-mid-adult-man-using-voice-commands-to-switch-on-the-light-control-the-brightness.jpg?s=2048x2048&w=is&k=20&c=Y2Je4dw9vDadE7BB_pqwar1-WgRY2v_lHSJzkWhlBuA=" alt="">
                    </button>
                </div>
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
            ...
            <div class="flex-shrink-0">
                <img class="h-10 w-10 rounded-full" src="https://media.istockphoto.com/id/1960517375/photo/unrecognized-mid-adult-man-using-voice-commands-to-switch-on-the-light-control-the-brightness.jpg?s=2048x2048&w=is&k=20&c=Y2Je4dw9vDadE7BB_pqwar1-WgRY2v_lHSJzkWhlBuA=" alt="">
            </div>
            <div class="ml-3">
                <div class="text-base font-medium leading-none text-white">Code Cinn</div>
                <div class="text-sm font-medium leading-none text-gray-400">codecinnpro@gmail.com</div>
            </div>
